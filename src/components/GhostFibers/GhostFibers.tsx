...
const contexts = new WeakMap<HTMLElement, ContextState>();
...
export const GhostFibers: React.FC<GhostFibersProps> = ({
  ...
  useEffect(() => {
    ...
    const reducedMotion = typeof window !== 'undefined' ? window.matchMedia('(prefers-reduced-motion: reduce)') : { matches: false, addEventListener: () => {}, removeEventListener: () => {} } as any;
